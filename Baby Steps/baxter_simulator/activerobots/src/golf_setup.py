...
# golf setup class--I changed from golf_setup so that I follow the naming convention
class GolfSetup():
    "Golf setup program"
    def __init__(self, arm):
        ...
        # This was needed in old rosbuild based packages but is no longer needed in catkin.
        # Will comment out because I am using a catkin workspace.
        ...
        # start positions--a 3D object requires 6 numbers to specify its pose in Cartesian space.
        self.x     = 0.60                        # x     = front back
        self.y     = 0.20                        # y     = left right
        self.z     = 0.15                        # z     = up down
        self.roll  = -1.0 * math.pi              # roll  = horizontal--rotate about x axis
        self.pitch = 0.0 * math.pi               # pitch = vertical-- rotate about y axis
        self.yaw   = 0.0 * math.pi               # yaw   = rotation--rotate about z axis
