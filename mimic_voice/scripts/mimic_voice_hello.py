...
WHAT THE MIMICVOICEHELLO CLASS DOES
...
WHAT THE MIMIC_VOICE_HELLO PROGRAM DOES

Baxter just says hello and then follows the user's arm 
movements.  

Please look at the three camera filter options in the program
and choose one to see which works best for you. 
_______________________________________________________________________
"""

class MimicVoiceHello():
...
if __name__ == '__main__':
    try:
        rospy.init_node('mimic_voice_hello', anonymous=True)
        mime = MimicVoiceHello()
